 ...
 * @generated
 */
public class MatrixServiceClp implements MatrixService {
    ...
    public MatrixServiceClp(InvokableService invokableService) {
    ...
    public ram.gameport.service.matrix.model.Matrix remove(long matrixId)
        ...
        try {
            returnObj = _invokableService.invokeMethod(_methodName6,
                    _methodParameterTypes6, new Object[] { matrixId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
